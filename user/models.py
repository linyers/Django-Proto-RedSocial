...
def user_directory_path_banner(instance, filename):
    banner_name = 'users/{0}/banner.jpg'.format(instance.user.username)
...
class Profile(models.Model):
    ...
    picture = models.ImageField(default='users/user_default_profile.png', upload_to=user_directory_path_picture)
